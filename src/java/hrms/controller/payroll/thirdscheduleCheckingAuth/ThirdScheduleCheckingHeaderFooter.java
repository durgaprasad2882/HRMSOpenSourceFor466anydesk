...
public class ThirdScheduleCheckingHeaderFooter extends PdfPageEventHelper {
    
    private String offName;
    private String empid;
    private String curDate;
    
    public ThirdScheduleCheckingHeaderFooter(String offName,String empid) throws IOException {
