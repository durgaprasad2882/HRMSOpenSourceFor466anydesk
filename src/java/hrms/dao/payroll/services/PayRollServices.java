...
public class PayRollServices {
    ...
    public File write(String billno, String folderPath, String fileSeparator, CommonReportParamBean crb) throws Exception {
        ...
        String fileName = "ACQT.txt";
        String originalFileName = "ACQT.txt";
        File dmp = null;
        ...
        try {
            ...
            //folderPath = folderPath + month + year + "/" + billNo + "/";
            originalFileName = folderPath + originalFileName;

            BillConfigObj billConfig = paybillDmpDao.getBillConfig(billno);
            aqlist = paybillDmpDao.getSectionWiseBillDtls(billno, month, year, "f1", billConfig, "R");
            
            //getSectionWiseBillDtls
                ...
                for (int i = 0; i < al.size(); i++) {
                    ...
                    for (int k = 0; k <= 7; k++) {
                        ...
                        if (column5.size() > k) {
                            ...
                            //}
                            //if(k == 4){
                            //row5 = row5+ " "+StringUtils.leftPad(StringUtils.clean(adbean.getAdamt()+""),6);
                            //}
                        } else {
                            if (k == 0) {
                                row1 = row1 + " " + StringUtils.leftPad(" ", 6);
                            ...
                            //}
                            //if(k == 4){
                            //row5 = row5+ " "+StringUtils.leftPad(" ",6);
                            //}
                        }
                        if (column6.size() > k) {
                        ...
                        if (column14.size() > k) {
                            ...
                            if (k == 0) {
                                row1 = row1 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 16);
                            }
                            if (k == 1) {
                                row2 = row2 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 16);
                            }
                            if (k == 2) {
                                row3 = row3 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 16);
                            }
                            if (k == 3) {
                                row4 = row4 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 16);
                            }
                        } else {
                            if (k == 0) {
                                row1 = row1 + " " + StringUtils.leftPad(" ", 16);
                            }
                            if (k == 1) {
                                row2 = row2 + " " + StringUtils.leftPad(" ", 16);
                            }
                            if (k == 2) {
                                row3 = row3 + " " + StringUtils.leftPad(" ", 16);
                            }
                            if (k == 3) {
                                row4 = row4 + " " + StringUtils.leftPad(" ", 16);
                            }
                        }
                        if (column15.size() > k) {
                            ADDetailsHealperBean adbean = (ADDetailsHealperBean) column15.get(k);
                            if (k == 0) {
                                row1 = row1 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 13);
                            }
                            if (k == 1) {
                                row2 = row2 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 13);
                            }
                            if (k == 2) {
                                row3 = row3 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 13);
                            }
                            if (k == 3) {
                                row4 = row4 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 13);
                            }
                        } else {
                            if (k == 0) {
                                row1 = row1 + " " + StringUtils.leftPad(" ", 13);
                            }
                            if (k == 1) {
                                row2 = row2 + " " + StringUtils.leftPad(" ", 13);
                            }
                            if (k == 2) {
                                row3 = row3 + " " + StringUtils.leftPad(" ", 13);
                            }
                            if (k == 3) {
                                row4 = row4 + " " + StringUtils.leftPad(" ", 13);
                            }
                        }
                        if (column16.size() > k) {
                        ...
                        if (column17.size() > k) {
                            ...
                            if (k == 4) {
                                row5 = row5 + " " + StringUtils.leftPad(adbean.getRefdesc() + StringUtils.clean(adbean.getAdamt() + ""), 11);
                            }
                        } else {
                            if (k == 0) {
                    ...
                    if (row7 != null && !row7.trim().equals("") && !row7.trim().equals("0")) {
                        //System.out.println("Inside Row7");
                        dmpUtil.writeToFile(row7);
                    }
                    if (row8 != null && !row8.trim().equals("") && !row8.trim().equals("0")) {
                        //System.out.println("Inside Row8");
                        dmpUtil.writeToFile(row8);
                    }
                    //System.out.println("Row 7:"+row7.trim()+"7");
                    //System.out.println("Row 8:"+row8.trim()+"8");
                    dmpUtil.writeToFile("-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
            ...
            /*dmpUtil.writeToFile((char)12);
             ...
             dmpUtil.writeToFile((char)64);
             dmpUtil.writeToFile((char)15);*/
            // printHeader(dmpUtil,crb,billdesc,billdate,pageNo+1);            
            printPageGrandTotal(dmpUtil, aqlist, totaq);
            
            grandTotal(dmpUtil, aqlist, pageNo + 1);
            
            //printCarryForward(dmpUtil,al,pageNo+1,ctrForLast,true);
            dmpUtil.writeToFile("");
        //originalList,"col3","BASIC",null)+""),6)

            //AqFunctionalities.getColGrandTotal(originalList,"col20","NETPAY",null)+"",8)
            dmpUtil.writeToFile(StringUtils.leftPad("RUPEES " + StringUtils.upperCase(Numtowordconvertion.convertNumber(AqFunctionalities.getColGrandTotal(aqlist, "col20", "NETPAY", null))) + " ONLY", characterPerLine));
            dmpUtil.writeToFile("");
            dmpUtil.writeToFile("");
            dmpUtil.writeToFile("");
            dmpUtil.writeToFile(StringUtils.leftPad(StringUtils.defaultString(crb.getDdoname()), characterPerLine, " "));

            String dphead = billFrontPageDmpDao.getDPHead(billno,crb.getAqmonth(),crb.getAqyear());
            String payhead = paybillDmpDao.getADCodeHead(billno, "GP",crb.getAqmonth(),crb.getAqyear());
            String dahead = paybillDmpDao.getADCodeHead(billno, "DA",crb.getAqmonth(),crb.getAqyear());
            ...
            dmpUtil.writeToFile("Pay   " + payhead + "= " + StringUtils.leftPad(payAbstract.get("pay").toString(), 7));
            dmpUtil.writeToFile("DP    " + dphead + "= " + StringUtils.leftPad(payAbstract.get("dp").toString(), 7));
            dmpUtil.writeToFile("DA    " + dahead + "= " + StringUtils.leftPad(payAbstract.get("da").toString(), 7));
            dmpUtil.writeToFile("HRA   403= " + StringUtils.leftPad(payAbstract.get("hra").toString(), 7));
            dmpUtil.writeToFile("OA    523= " + StringUtils.leftPad(payAbstract.get("oa").toString(), 7));
            dmpUtil.writeToFile("------------------");
            ...
            dmpUtil.writeToFile("");
            String leftspace = "                                                     ";
            Schedule gpfSchedule = getScheduleData(scheduleList, "GPF");
            ...
            dmpUtil.writeToFile(leftspace + "HRR           3321= Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col12", "HRR", null) + "", 9) + "GEN HBA ADV 8678(55521)=Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col13", "HBA", "P") + "", 9));
            ...
            dmpUtil.writeToFile(leftspace + "SWR               = Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col12", "SWR", null) + "", 9) + "EX. PAY            =Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col17", "EP", null) + "", 9));
            ...
            dmpUtil.writeToFile(leftspace + "INC.TAX 7112(58816)= Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col11", "IT", null) + "", 9) + "GPF           8690(55545)=Rs" + StringUtils.rightPad((paybillDmpDao.getGPFAmount( billno, "8690")) + "", 9) + "  " + StringUtils.rightPad((paybillDmpDao.getGPFAmount(billno, "55545")) + "", 9));
            dmpUtil.writeToFile(leftspace + "                               " + "AISGPF       8692(57649)=Rs" + StringUtils.rightPad((paybillDmpDao.getGPFAmount(billno, "8692")) + "", 9) + "  " + StringUtils.rightPad((paybillDmpDao.getGPFAmount(billno, "57649")) + "", 9));
            ...
            dmpUtil.writeToFile(leftspace + "CPF   30594(57740)= Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col10", "CPF", null) + "", 9) + "PAY ADV           =Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col16", "PA", null) + "", 9));
            //dmpUtil.writeToFile(leftspace+"TPF          7058= Rs"+StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist,"col10","TPF",null)+"",9)+"TPF ADV           7058=Rs"+StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist,"col110","TPFGA",null)+"",9));
            dmpUtil.writeToFile(leftspace + "TLIC          7129= Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col9", "TLIC", null) + "", 9) + "COMPUTER ADV.(P) 30015(57635)= Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col18", "CMPA", "P") + "", 9));
