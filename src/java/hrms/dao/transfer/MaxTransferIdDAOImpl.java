...
@Repository
@Scope("singleton")
public class MaxTransferIdDAOImpl implements MaxTransferIdDAO{
    ...
    @Override
    public String getMaxTransferId() {
        Statement st = null;
        ResultSet rs = null;
        ...
        try {
            if (mCode != null) {
                ...
                rs = st.executeQuery("SELECT MAX(cast ( TR_ID as BIGINT )) MCODE FROM EMP_TRANSFER");
                if (rs.next()) {
