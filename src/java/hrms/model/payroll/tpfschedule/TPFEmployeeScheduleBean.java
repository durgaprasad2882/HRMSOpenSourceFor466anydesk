...
public class TPFEmployeeScheduleBean {

    private String netAmount;
    private String carryForward;
    private String carryForwardddo;
    ...
    public String getGpfAcc() {
        return gpfAcc;
    }

    public void setGpfAcc(String gpfAcc) {
        this.gpfAcc = gpfAcc;
    }
