...
public class AqMastBean {
    ...
    private String spcOrdDate = null;
    ...
    public int getAqGroup() {
        return aqGroup;
    }

    public void setAqGroup(int aqGroup) {
    ...
    public int getMonBasic() {
        return monBasic;
    }

    public void setMonBasic(int monBasic) {
    ...
    public String getSpcOrdDate() {
        return spcOrdDate;
    }

    public void setSpcOrdDate(String spcOrdDate) {
