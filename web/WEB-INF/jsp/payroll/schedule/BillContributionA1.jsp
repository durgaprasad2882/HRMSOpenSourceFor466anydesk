    ...
    <div style="width:99%;margin: 0 auto;font-size:13px; font-family:verdana;">
        ...
        <table border="0" width="100%"  cellspacing="0" style="font-size:12px; font-family:verdana;">
            ...
            <c:forEach var="eachEmpNps" items="${NpsEmpList}">
                ...
                <c:if test="${not empty eachEmpNps.pagebreakAnx}">
                    <tr>
                        <td colspan="7" class="pgHeader" style="text-align:right; text-transform: uppercase;">Carry Forward:</td>
                        <td style="text-align:center;padding-left: 10px;font-weight: bold;"> <c:out value="${eachEmpNps.cpfCaryFrd}"/> </td> 
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px;font-family:verdana;">
            <tr style="height:30px">
                ...
                <td width="6%" align="center"><b><c:out value="${TotGcpf}"/></b></td>
            </tr>
            <tr>
            ...
            <tr style="height:30px">
                ...
                <td width="8%">&nbsp;</td>
                <td width="5%">&nbsp;</td>
                <td width="8%" colspan="2">RUPEES&nbsp; <b><c:out value="${TotCpfFig}"/></b>&nbsp;ONLY</td>
                <td width="6%">&nbsp;</td>
                <td width="6%" colspan="2">RUPEES&nbsp;<b><c:out value="${TotGcpfFig}"/></b>&nbsp;ONLY</td>
            </tr>
            <tr>
                <td colspan="11" height="5px"><hr/></td>
            </tr>
