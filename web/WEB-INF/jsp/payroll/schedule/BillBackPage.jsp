            ...
            <td width="50%" valign="top" class="borderTopandRight">
                <table style="font-size:15px" border="0" width="100%" cellpadding="0" cellspacing="0" >
                    <tr> 
                        ...
                        <td align="right" class="borderBottom" style="font-size:20px"> <c:out value="${BPGHeader.totalPaise}"/> &nbsp;</td>
                    </tr>
                    <c:if test="${not empty BPGList}">
                        <c:forEach var="eachEmpList" items="${BPGList}">
                            <tr style="font-size: 20px">
                                <td width="30%"><c:out value="${eachEmpList.scheduleName}"/>&nbsp;</td>
                                <td width="20%" class="borderRight"> &nbsp;</td>
                                <td width="25%" align="right" class="borderRight"><c:out value="${eachEmpList.schAmount}"/>&nbsp; </td>
                                <td width="25%">&nbsp; </td>
                            </tr>
                        </c:forEach>
                    </c:if>
