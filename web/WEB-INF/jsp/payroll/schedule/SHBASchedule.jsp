                ...
                <c:if test="${not empty EmpPrincpalList}">
                    <c:forEach var="eachEmpShbaP" items="${EmpPrincpalList}">
                        <tr style="height:30px">
                            <td width="4%" align="center" style="border-bottom:1px solid #000000;">&nbsp;<c:out value="${eachEmpShbaP.slno}"/></td>
    ...
    <div style="width:97%;margin: 0 auto;font-size:13px; font-family:verdana;">
        ...
        <table border="0" width="100%"  cellspacing="0" style="font-size:12px; font-family:verdana;">
            ...
            <c:forEach var="eachEmpIntShba" items="${EmpInterestList}">
                <tr style="height:30px">
                    <td width="5%" align="center" style="border-bottom:1px solid #000000;">&nbsp;<c:out value="${eachEmpIntShba.slno}"/></td>
                    ...
                    <td width="10%" align="right" style="border-bottom:1px solid #000000;">&nbsp;<c:out value="${eachEmpIntShba.accNo}"/></td> 
