...
<html>
    <head>
        ...
        <title>:: WATER RENT SCHEDULE ::</title>
    </head>
    <body>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px;font-family:verdana;">
            ...
            <tr>
                <td width="23%" colspan="2" style="text-align: left;font-family:verdana;">
                    TOTAL FOR THE MONTH OF&nbsp;<c:out value="${WRRHeader.txtMonth}"/>-<c:out value="${WRRHeader.txtYear}"/> 
                </td>
                <td width="25%" style="text-align: center">&nbsp;</td>
                <td width="12%" style="text-align: center"><b><c:out value="${Amount}"/></b></td>                            
        ...
        <table width="100%" border="0" style="font-size:12px;font-family:verdana;">
            ...
            <tr>
                ...
                <td style="text-align: center" class="printData">
                    Signature of D.D.O.<br> <c:out value="${offName}"/>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
