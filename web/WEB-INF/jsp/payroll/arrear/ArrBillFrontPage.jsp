        ...
        <div align="center">
            <div style="width:1000px;margin-top: 10px">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:verdana;" id="tableset">
                                    ...
                                    <td valign="top">
                                        <table border="0" width="100%" style="font-family:verdana;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr style="font-family:verdana;font-size:14px">
                                                ...
                                                <td>&nbsp; </td>
                                                    ...
                                                    <tr style="font-family:verdana;font-size:18px">
                                                        <td>&nbsp; 855</td>
                                                    <td class="borderRight">Arrear Allowance &nbsp;</td>   
                                            ...
                                            <tr style="font-family:verdana;font-size:14px">
                                                ...
                                                <td class="borderTopRightandBottom" align="right"><c:out value="${payAmt}"/> &nbsp;</td>
                    ...
                    <tr style="font-family:verdana;font-size:18px">
                        <td>&nbsp; <c:out value="${itObjHead}"/></td>
                    <td class="borderRight">IT &nbsp;</td>   
                    <td class="borderRight" align="right"><c:out value="${itAmt}"/> &nbsp;</td> 
                    <td>&nbsp; </td>
                    </tr>
                    <tr style="font-family:verdana;font-size:18px">
                        <td>&nbsp; <c:out value="${cpfObjHead}"/></td>
                    <td class="borderRight">CPF &nbsp;</td>   
                    <td class="borderRight" align="right"><c:out value="${cpfAmt}"/> &nbsp;</td> 
                    <td>&nbsp; </td>
                    </tr>
                    <tr style="font-family:verdana;font-size:18px">
                        <td>&nbsp; <c:out value="${ptfObjHead}"/></td>
                    <td class="borderRight">PT &nbsp;</td>   
                    <td class="borderRight" align="right"><c:out value="${ptAmt}"/> &nbsp;</td> 
                    <td>&nbsp; </td>
                    </tr>
