...
<html>
    ...
    <div style="width:90%;margin: 0 auto;">
        <table width="100%" border="0">
            <tr>
                <td style="text-align:center;font-size:15px;font-weight:bold;"><u>ANNEXURE- III</u></td>
            </tr>
            <tr>
                <td  style="text-align:center;font-size:15px;"> FORMAT OF SCHEDULE FOR EMPLOYEES AND EMPLOYER CONTRIBUTIONS </td>
            </tr>
            <tr>
    ...
    <div style="width:99%;margin: 0 auto;font-size:13px; font-family:verdana;">
        ...
        <table border="0" width="100%"  cellspacing="0" style="font-size:12px; font-family:verdana;">
            <tr>
                ...
                <td width="10%" class="tblHeader">PRAN</td>
                <td width="25%" class="tblHeader">Employee Name</td>
                <td width="17%" class="tblHeader">Designation</td>
                <td width="10%" class="tblHeader">Bill No and Date of Employees Contribution</td>
                <td width="10%" class="tblHeader">Amount of Employees Contribution</td>
                <td width="10%" class="tblHeader">Bill No & Date of Govt. Contribution</td>
                <td width="10%" class="tblHeader">Amount of Govt. Contribution</td>
                <td width="10%" class="tblHeader">Total in Rs.</td>
            </tr>
            <tr>
            ...
            <c:forEach var="eachEmpNps" items="${NpsEmpList}">
                <tr style="height:35px">
                    ...
                    <td align="center" style="border-bottom:1px solid #000000;">&nbsp;
                            <c:out value="${NPSHeader.billDesc}"/></br>/&nbsp;<c:out value="${NPSHeader.billDate}"/>
                    </td>
                ...
                <c:if test="${not empty eachEmpNps.pagebreakAnx}">
                    <tr>
                        ...
                        <td style="text-align:center;padding-left: 10px;font-weight: bold;"> <c:out value="${eachEmpNps.totCaryFrd}"/> </td> 
                        <td style="text-align:center;padding-left: 10px;font-weight: bold;"> <c:out value="${eachEmpNps.anx3CaryFrd}"/> </td> 
                    </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px;font-family:verdana;">
            <tr style="height:30px">
                ...
                <td width="10%" align="center"><b>Grand Total</b></td>
                <td width="10%" align="center"><b><c:out value="${TotGcpf}"/></b></td>
                <td width="10%"><b><c:out value="${GrandTot}"/></b></td>
            </tr>
            <tr>
