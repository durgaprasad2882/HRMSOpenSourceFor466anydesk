...
<html>
    ...
    <body>
         <div id="deputationTool" style="padding:3px">                    
            <a href="javascript:newRecruitment();" class="easyui-linkbutton" data-options="iconCls:'icon-add'" plain="true" id="addBtn">Add New</a>
            <a href="javascript:newRecruitment();" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" plain="true" id="editBtn">Edit</a>
        </div>
        <div style='clear:both'></div>
        <input type="hidden" id="type"/>
        <table id="deputationdg" class="easyui-datagrid" style="width:100%;height:400px;" title="Recruitment List"
               rownumbers="true" singleSelect="true" url="GetRecruitmentListJSON.htm" singleSelect="true" pagination="true" collapsible="false"
               data-options="nowrap:false,fitColumns:false" toolbar="#RecruitmentTool">
            <thead>
                <tr>
       ...
       <div id="dlg" class="easyui-dialog" title="Deputation New/Edit" data-options="iconCls:'icon-save',closed: true,modal: true" style="width:900px;height:600px;padding:10px" buttons="#dlg-buttons">
            <form id="RecruitmentForm" method="POST" commandName="RecruitmentForm">
