                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">                            
                                ...
                                <li class="active">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-file"></i> Add Court Case Details
                                    </li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form:form role="form" action="saveCommissionCourtCase.htm" commandName="saveCommissionCourtCase"  method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="courtCaseNo" type="text" class="form-control" id="CourtCaseNo"  required>
                                        </div>
                                        <div class="form-group">
                                            <label for="orderDate">Court Case Date</label>
                                            <input name="courtCaseDate" type="date" class="form-control" id="CourtCaseDate"  >
                                        </div>
                                         <div class="form-group">
                                            <label for="VivavoceDate">Date of Submission Of PWC</label>
                                            <input name="pwcDate" type="date" class="form-control" id="PWCDate"  >
                                        </div>
                                          <div class="form-group">
                                            <label for="VivavoceDate">Date of Filing Counter Affedevit</label>
                                            <input name="affedevitdate" type="date" class="form-control" id="Affedevitdate"  >
                                        </div>
                                         <div class="form-group">
                                            <label for="VivavoceDate">Date of Interim Order</label>
                                            <input name="interimorder" type="date" class="form-control" id="Interimorder"  >
                                        </div>
                                         <div class="form-group">
                                            <label for="VivavoceDate">Date of Final Judgement</label>
                                            <input name="judgementDate" type="date" class="form-control" id="JudgementDate"  >
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <input name="orderPassed" type="text" class="form-control" id="OrderPassed"  required>
                                        </div>
                                         <div class="form-group">
                                            <label for="noOfSelectedCanddiates">Steps Taken for Vacation Of Stay <span style='color:red; font-weight:bold;'>*</span></label>
                                            <input name="stepsStay" type="text" class="form-control" id="StepsStay"  >
                                        </div>
                                       <div class="form-group">
                                            <label for="VivavoceDate">Date of Vacation Of Stay</label>
                                            <input name="stayDate" type="date" class="form-control" id="StayDate"  >
                                        </div>
                                        <div class="form-group">
