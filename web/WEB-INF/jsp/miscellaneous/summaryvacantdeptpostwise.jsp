                            ...
                            <div class="col-lg-12">
                                ...
                                <c:if test = "${not empty selectyear}">        
                                 ...
                                 <table width="100%" cellspacing="1" cellpadding="4" border="0" bgcolor="#EAEAEA" class="form-table" style="border:1px solid #CCCCCC;" >
                                   ...
                                   <tr>
                                        <td colspan="4" align="center"><input type="submit" class="btn btn-primary" value="Back" onclick="Javascript:window.location='getDeptvacantpostList.htm?month=${selectmonth}&year=${selectyear}'"  />&nbsp;<input type="button" class="btn btn-primary" value="Entry Details" onclick="Javascript:window.location='entryDetailsList.htm?month=${selectmonth}&year=${selectyear}'"  /></td>
                                    </tr>
                                 </table>
                            </div>
                        </div>
