                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row" style="min-height:600px">
                            <div class="col-lg-12">
                                <h2 style="margin-top:0px;">Department Wise Rehabilitation Scheme MIS </h2>

                                <form:form role="form" action="deptRaSchemeList.htm" commandName="deptRaSchemeList"  method="post">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td colspan="2" align="center"><input type="submit" class="btn btn-primary" value="Submit"  /></td>
                                                  <td colspan="2" align="center"><input type="button" class="btn btn-primary" value="Summary" onclick="javascript:self.location='summaryRaschemeList.htm'" /></td>
                                            </tr>
                                        </table>
                                        <!-- /.box-body -->
                                ...
                                <table id="account" class="table table-bordered table-striped" >
                                    <thead>
                                        <tr style='background-color:black;color:white;font-size:14px'>
                                             <th colspan="2" align='center'>Department Wise Rehabilitation Scheme Entry Status For month Of ${selectmonth}, ${selectyear}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td> <c:if test = "${not empty rascheme.raSchemeId && rascheme.raSchemeId >='1'}">  <strong style='color:green'>Submitted</strong></c:if><c:if test = "${not empty rascheme.raSchemeId && rascheme.raSchemeId=='0'}">  <strong style='color:red'>Pending</strong></c:if></td>
