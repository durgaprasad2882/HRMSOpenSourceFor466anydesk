                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row" style="min-height:600px">
                            <div class="col-lg-12">
                                <h2 style="margin-top:0px;">Department Wise Vacant Post Summary </h2>

                                <form:form role="form" action="summarydeptVacantPostList.htm" commandName="deptVacantPostList"  method="post">
                                        ...
                                        <tbody>
                                            <c:if test = "${not empty vacantPostList}"> 
                                                ...
                                                <c:forEach items="${vacantPostList}" var="vacantPost">
                                                    ...
                                                    <tr scope="row">
                                                        <td>${slno}</td>
                                                        <td><a href='summaryvacantgroupwise.htm?deptid=${vacantPost.deptId}&month=${vacantPost.month}&year=${vacantPost.year}&deptname=${vacantPost.deptName}'>${vacantPost.deptName}</a></td>
