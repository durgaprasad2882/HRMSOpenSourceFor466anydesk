                                                ...
                                                <c:forEach items="${vacantPostList}" var="vacantPost">
                                                   ...
                                                   <c:set var="bpost" value="${vacantPost.postFilledUp - vacantPost.totalpostFilledUp}" />
                                                    <c:set var="postsBalanceTotal" value="${postsBalanceTotal + bpost}" />
                                                      <tr scope="row">
                                                        <td><a href='summaryvacantpostwise.htm?deptid=${vacantPost.deptId}&gname=${vacantPost.groupName}&month=${vacantPost.month}&year=${vacantPost.year}&deptname=${selectdeptname}'>${vacantPost.groupName}</a></td>
