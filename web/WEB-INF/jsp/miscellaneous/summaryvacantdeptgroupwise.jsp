                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row" style="min-height:600px">
                            <div class="col-lg-12">
                                <h2 style="margin-top:0px;">Group Wise Vacant Post Summary </h2>
                                ...
                                <c:if test = "${not empty selectyear}">        
                                    <table id="account" class="table table-bordered table-striped" >
                                        <thead>
                                            <tr style='background-color:black;color:white;font-size:14px'>
                                                <th colspan="12" align='center'>${selectdeptname}</th>
                                                ...
                                                <c:forEach items="${vacantPostList}" var="vacantPost">
                                                   ...
                                                   <c:set var="bpost" value="${vacantPost.postFilledUp - vacantPost.totalpostFilledUp}" />
                                                    <c:set var="postsBalanceTotal" value="${postsBalanceTotal + bpost}" />
                                                      <tr scope="row">
                                                        <td><a href='summaryvacantdeptpostwise.htm?deptid=${vacantPost.deptId}&gname=${vacantPost.groupName}&month=${vacantPost.month}&year=${vacantPost.year}&deptname=${selectdeptname}'>${vacantPost.groupName}</a></td>
                                 ...
                                 <table width="100%" cellspacing="1" cellpadding="4" border="0" bgcolor="#EAEAEA" class="form-table" style="border:1px solid #CCCCCC;" >
                                   ...
                                   <tr>
                                        <td colspan="4" align="center"><input type="submit" class="btn btn-primary" value="Back" onclick="Javascript:window.location='getDeptvacantpostList.htm?month=${selectmonth}&year=${selectyear}'"  /></td>
                                    </tr>
                                 </table>
                            </div>
                        </div>
