        ...
        <script language="javascript1.2" type="text/javascript">
            $(document).ready(function() {
                ...
                $('#dgleaveauthority').datagrid({
                    url: 'SelectSanctionAuthorityAction.htm',
                    method: 'post'
                });
            });
            ...
            function SelectPost() {
                ...
                var desg = radspl[2];
                var spc = radspl[3];
                parent.SelectSpn(empId, name, desg, spc);
            }
        </script>
    </head>
    <body >
        <form:form  action="leaveauthority.htm" method="POST" commandName="leaveAuthorityForm">
