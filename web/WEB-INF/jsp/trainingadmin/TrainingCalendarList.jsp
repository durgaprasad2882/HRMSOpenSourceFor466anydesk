    ...
    <body>
        <jsp:include page="Header.jsp">
            <jsp:param name="menuHighlight" value="CALENDAR" />
                ...
                <h1 style="margin:0px;font-size:18pt;color:#333333;border-bottom:1px solid #DADADA;padding-bottom:5px;">Training Calendar</h1>
                <div style="padding:10px 0px;">
                    <a href="javascript:void(0)" onclick="javascript:openWindow('TrainingProgramController.htm?opt=calendar&amp;date=01-Dec-2016','Manage Training Program')" style="font-weight:bold;"><img src="images/add_icon.png" alt=""  /> Add Training</a> &nbsp;&nbsp;&nbsp;
                ...
                <form class="form-control-inline" name="frmTraining"  id="frmTraining" action="TrainingProgramAction.htm" method="POST" commandName="TrainingProgramForm" onsubmit="javascript: return validateAdd()">
                    <table id="dg" class="easyui-datagrid" style="width:100%;height:400px;" title="Training Calendar" 
                        ...
                        <thead>
                            <tr>
                                <th data-options="field:'programName',width:'30%'" style="font-weight:bold;">Training Program Name</th>
