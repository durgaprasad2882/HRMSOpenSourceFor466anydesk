    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $.ajax({
                    url: 'GetAssignedFacultyList.htm',
                    type: 'get',
                    data: 'trainingId='+$('#trainingId').val(),
                    success: function (retVal) {
                        $('#faculty_list').html(retVal);
                    }
                });
            });
            function selectFaculty(cID, ele)
            {
                var isChecked = 'N';
                if (ele.checked)
                {
                ...
                else
                {
                    $('#li_' + cID).css('background', '#FFFFFF');
                                ...
                                $.ajax({
                    url: 'AssignFacultyListAction.htm',
                    data: 'facultyCode='+cID+'&trainingId='+$('#trainingId').val()+'&status='+isChecked,
                    type: 'get',
                    success: function (retVal) {
