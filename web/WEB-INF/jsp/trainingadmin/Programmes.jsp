...
<html>
    <head>
        ...
        <title>Training Programmes:: HRMS</title>
        ...
        <style type="text/css">
            ...
            .institute h2{font-size:13pt;color:#0173c9;margin:0px;margin-bottom:7px;}          
        </style>
<script type="text/javascript">
            	$.ajax({
	  url: 'UpcomingTrainingPrograms.htm',
	  type: 'get',
	  success: function(retVal) {
              $('#program_blk').html(retVal);
	  }
	});
            </script>        
    </head>
    <body>
            ...
            <h1 style="margin:0px;font-size:18pt;margin-bottom:8px;">Training Programmes</h1>
            <div id="program_blk"></div>
